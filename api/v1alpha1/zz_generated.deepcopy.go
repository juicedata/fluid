...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JuiceFuseSpec) DeepCopyInto(out *JuiceFuseSpec) {
	*out = *in
	if in.Env != nil {
		in, out := &in.Env, &out.Env
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JuiceFuseSpec.
func (in *JuiceFuseSpec) DeepCopy() *JuiceFuseSpec {
	if in == nil {
		return nil
	}
	out := new(JuiceFuseSpec)
	in.DeepCopyInto(out)
	return out
}
